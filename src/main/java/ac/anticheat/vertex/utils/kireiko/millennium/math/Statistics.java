...
import ac.anticheat.vertex.utils.kireiko.millennium.vectors.Pair;
...
public final class Statistics {
    ...
    public static double getZCR(List<? extends Number> values) {
    ...
    public static double spearmanCorrelation(List<? extends Number> x, List<? extends Number> y) {
        ...
        return getPearsonCorrelation(rankX, rankY);
    }
